...
TableStore.prototype.updateColumns = function() {
  ...
  // 过滤出 fixed 存在，或者fixed 等于left 的 行

  states.fixedColumns = _columns.filter((column) => column.fixed === true || column.fixed === 'left');
  //  过滤出 fixed 等于 right 的 数据
  ...
  //   对states 的标志位进行判断， 如果存在 fixedcolumns  和  right 的数组，就把 states 的 isComplex  设置为true
